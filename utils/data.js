...
const monsters = {
  // ---- 1-5层 黏液沼泽 ----
  slime: [
    { name: '小史莱姆', hp: 40, attack: 11, defense: 2, exp: 16, gold: 4, level: 1, critChance: 0.05, dodgeChance: 0.05, desc: '一滩会动的绿色黏液', icon: '🟢' },
    { name: '大史莱姆', hp: 80, attack: 18, defense: 5, exp: 32, gold: 8, level: 2, critChance: 0.06, dodgeChance: 0.04, desc: '体型庞大的黏稠怪物', icon: '🟩' },
    { name: '毒液史莱姆', hp: 70, attack: 22, defense: 6, exp: 40, gold: 10, level: 3, critChance: 0.12, dodgeChance: 0.08, desc: '体表泛着危险紫光的剧毒史莱姆', icon: '🟣' },
    { name: '黏土怪', hp: 100, attack: 24, defense: 9, exp: 48, gold: 12, level: 3, critChance: 0.05, dodgeChance: 0, desc: '由沼泽淤泥凝聚成的怪物，皮糙肉厚', icon: '🟤' },
    { name: '巨鼠', hp: 90, attack: 26, defense: 6, exp: 52, gold: 14, level: 4, critChance: 0.10, dodgeChance: 0.15, desc: '沼泽边长大的巨型老鼠，动作敏捷', icon: '🐀' }
  ],
...
const bosses = [
  {
    name: '史莱姆之王',
    hp: 240, attack: 40, defense: 14, exp: 200, gold: 90,
    level: 5,
    floorOfAppearance: 5,
