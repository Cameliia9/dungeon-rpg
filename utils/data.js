...
const monsters = {
  ...
  // ---- 6-10层 骸骨墓穴 ----
  bone: [
    { name: '骷髅兵', hp: 153, attack: 31, defense: 10, exp: 75, gold: 17, level: 6, critChance: 0.08, dodgeChance: 0.02, desc: '死去冒险者的遗骸，挥剑有力', icon: '🦴' },
    { name: '骷髅射手', hp: 187, attack: 38, defense: 13, exp: 84, gold: 19, level: 6, critChance: 0.15, dodgeChance: 0.08, desc: '弓弦崩响，骨箭破空而来', icon: '🏹' },
    { name: '腐尸', hp: 204, attack: 41, defense: 14, exp: 90, gold: 20, level: 7, critChance: 0.05, dodgeChance: 0, desc: '散发着恶臭的不死生物，动作迟缓', icon: '🧟' },
    { name: '食尸鬼', hp: 213, attack: 43, defense: 14, exp: 99, gold: 23, level: 8, critChance: 0.12, dodgeChance: 0.10, desc: '饥渴的食尸者，扑食速度极快', icon: '👺' },
    { name: '墓穴僵尸', hp: 221, attack: 45, defense: 15, exp: 108, gold: 25, level: 9, critChance: 0.05, dodgeChance: 0, desc: '被墓穴诅咒复活的巨型僵尸', icon: '🧟♂️' }
  ],
